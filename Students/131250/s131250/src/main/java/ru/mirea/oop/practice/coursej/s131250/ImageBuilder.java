...
public class ImageBuilder {
    ...
    public static String textWrite(String im1, String text) {
        ...
        try {
            ...
            g2d2.dispose();
            ImageIO.write(result, "gif", new File(HomeDirLoader.HOMEDIR + number + ".gif"));
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        return HomeDirLoader.HOMEDIR + number + ".gif";
    }
    ...
    public static String combImages(String im1, String im2) {
        ...
        try {
            ...
            ImageIO.write(im, "gif", new File(HomeDirLoader.HOMEDIR + number + ".gif"));
        } catch (IOException e) {
            e.printStackTrace();
        }
        File file = new File(im1);
